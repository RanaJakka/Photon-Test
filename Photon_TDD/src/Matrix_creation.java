...
import java.util.Stack;import javax.swing.plaf.basic.BasicBorders.MarginBorder;
...
public class Matrix_creation {
	...
	public void setEelementsInMatrix(int[] x)
	{
		int in_posi=0;
	...
	public void path_weight() {
			...
			System.out.println("Shortest Cost :"+final_list_t.get(0).Total_cost()+"\n");
			System.out.println(" And it'sPath :"+final_list_t.get(0).row_path()+"\n");
